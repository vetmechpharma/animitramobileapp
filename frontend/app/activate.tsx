...
const styles = StyleSheet.create({
  ...
  appName: { fontSize: 24, fontWeight: '800', color: C.primary, marginTop: 10, letterSpacing: -0.5 },
  // Section toggle
  ...
  toggleBtnActive: { backgroundColor: C.surface, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 6, elevation: 2 },
  ...
  card: {
    ...
    shadowOpacity: 0.07, shadowRadius: 20, elevation: 4, alignItems: 'center',
  },
  welcomeEmoji: { fontSize: 48, marginBottom: 12 },
  title: { fontSize: 21, fontWeight: '800', color: C.textPrimary, textAlign: 'center', marginBottom: 8 },
  ...
  otpBox: {
    ...
    fontSize: 20, fontWeight: '800', color: C.primary, textAlign: 'center',
  },
  ...
  activateBtnText: { color: '#fff', fontSize: 16, fontWeight: '700', letterSpacing: 0.3 },
  ...
  // Payment section
  planBadge: { fontSize: 13, fontWeight: '700', color: C.primary, backgroundColor: C.surfaceSecondary, paddingHorizontal: 12, paddingVertical: 4, borderRadius: 20, marginBottom: 10 },
  planPrice: { fontSize: 40, fontWeight: '800', color: C.textPrimary },
  planPriceSmall: { fontSize: 16, fontWeight: '500', color: C.textSecondary },
  ...
  qrLabel: { fontSize: 14, fontWeight: '700', color: C.textPrimary, marginBottom: 12 },
  qrBox: { backgroundColor: '#fff', padding: 16, borderRadius: 16, marginBottom: 12 },
  upiId: { fontSize: 14, color: C.textSecondary },
  upiIdValue: { color: C.primary, fontWeight: '800' },
  upiNote: { fontSize: 12, color: C.textSecondary, marginTop: 6, textAlign: 'center' },
  utrLabel: { fontSize: 13, fontWeight: '600', color: C.textSecondary, alignSelf: 'flex-start', marginBottom: 8, marginTop: 4 },
  ...
  utrSuccessTitle: { fontSize: 20, fontWeight: '800', color: C.primary, marginBottom: 8 },
