...
const styles = StyleSheet.create({
  ...
  logoCircle: {
    ...
    shadowColor: '#2E7D32', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 3,
  },
  logoEmoji: { fontSize: 40 },
  appName: { fontSize: 26, fontWeight: '800', color: C.primary, marginTop: 12, letterSpacing: -0.5 },
  card: {
  ...
  welcomeEmoji: { fontSize: 52, marginBottom: 14 },
  ...
  otpBox: {
    width: 38, height: 54,
    borderRadius: 14, backgroundColor: C.fill,
    borderWidth: 1.5, borderColor: '#C8E6C9',
    fontSize: 20, fontWeight: '800', color: C.primary,
    textAlign: 'center',
  },
  otpBoxFilled: {
    borderColor: C.primaryLight, backgroundColor: C.fillFocus,
  },
