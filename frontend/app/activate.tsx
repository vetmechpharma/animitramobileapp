...
const styles = StyleSheet.create({
  ...
  loginLink: { fontSize: 13, color: C.primary, fontWeight: '600', fontFamily: 'Inter_600SemiBold' },
  // Payment section
  ...
  planPriceSmall: { fontSize: 14, fontWeight: '500', fontFamily: 'Inter_500Medium', color: C.textSecondary },
  planDesc: { fontSize: 14, color: C.textSecondary, textAlign: 'center', lineHeight: 21, marginVertical: 14 },
  qrCard: { backgroundColor: C.fill, borderRadius: 20, padding: 14, alignItems: 'center', width: '100%', marginBottom: 16 },
  ...
  utrInput: { width: '100%', height: 46, borderRadius: 14, backgroundColor: C.fill, paddingHorizontal: 16, fontSize: 14, color: C.textPrimary, marginBottom: 8 },
