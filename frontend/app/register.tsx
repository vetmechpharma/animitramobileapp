...
const C = {
  primary: '#2E7D32', bg: '#FDFBF7', surface: '#FFFFFF',
  surfaceSecondary: '#E8F5E9', textPrimary: '#0A1F10',
  textSecondary: '#4A5D4E', border: '#E0E8E1',
};
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    backgroundColor: C.surface, paddingHorizontal: 16, fontSize: 16, color: C.textPrimary,
  },
  ...
  dropdownDisabled: { backgroundColor: '#F5F5F5', opacity: 0.7 },
  dropdownText: { fontSize: 16, color: C.textPrimary, flex: 1 },
  placeholder: { color: '#9EB09F' },
  dropdownArrow: { fontSize: 12, color: C.textSecondary },
  registerBtn: {
  ...
  modalHandle: { width: 40, height: 4, backgroundColor: C.border, borderRadius: 2, alignSelf: 'center', marginTop: 12, marginBottom: 16 },
  ...
  dropdownItem: {
    paddingVertical: 14, paddingHorizontal: 8, borderBottomWidth: 1, borderBottomColor: '#F0F4F1',
  },
