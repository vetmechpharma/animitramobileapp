...
const s = StyleSheet.create({
  ...
  profileCard: {
    ...
    backgroundColor: C.primary, borderRadius: 24, padding: 20, marginBottom: 12,
  },
  avatarCircle: {
  ...
  docName: { fontSize: 18, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: '#fff' },
  ...
  statPillNum: { fontSize: 22, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: C.primary },
  ...
  menuTextWrap: { flex: 1 },
  menuLabel: { fontSize: 15, fontWeight: '600', fontFamily: 'Inter_600SemiBold', color: C.text },
  menuLabelDanger: { color: C.error },
  menuSub: { fontSize: 12, color: C.sub, marginTop: 2 },
  menuArrow: { fontSize: 22, color: C.sub, fontWeight: '300' },
  // Footer
  footer: { alignItems: 'center', paddingTop: 24, gap: 4 },
  footerEmoji: { fontSize: 28, marginBottom: 4 },
  footerName: { fontSize: 16, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: C.primary },
