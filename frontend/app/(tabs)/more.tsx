...
const s = StyleSheet.create({
  ...
  docName: { fontSize: 18, fontWeight: '800', color: '#fff' },
  ...
  statPillNum: { fontSize: 22, fontWeight: '800', color: C.primary },
  statPillLabel: { fontSize: 11, color: C.sub, marginTop: 2 },
  statDivider: { width: 1, height: 36, backgroundColor: C.border },
  // Menu sections
  section: { marginBottom: 16 },
  sectionLabel: { fontSize: 11, fontWeight: '700', color: C.sub, letterSpacing: 1, marginBottom: 8, marginLeft: 4 },
  sectionCard: {
  ...
  footerName: { fontSize: 16, fontWeight: '800', color: C.primary },
