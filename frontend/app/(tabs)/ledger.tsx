...
const s = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: C.text },
  ...
  totalLeft: { flex: 1 },
  totalAmount: { fontSize: 32, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: '#fff' },
  ...
  totalFarmerNum: { fontSize: 28, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: '#fff' },
  ...
  emptyTitle: { fontSize: 20, fontWeight: '700', fontFamily: 'Inter_700Bold', color: C.text, marginBottom: 4 },
  ...
  farmerAvatarText: { fontSize: 18, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: C.error },
  farmerName: { fontSize: 16, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: C.text },
  farmerVillage: { fontSize: 12, color: C.sub, marginTop: 1 },
  farmerCases: { fontSize: 12, color: C.sub, marginTop: 2 },
  farmerTotal: { fontSize: 22, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: C.error },
  ...
  caseOutstanding: { fontSize: 15, fontWeight: '700', fontFamily: 'Inter_700Bold', color: C.error },
  ...
  totalRowAmount: { fontSize: 16, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: C.error },
  // Farmer actions
  ...
  sheetTitle: { fontSize: 20, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: C.text },
  ...
  summaryTotal: { fontSize: 20, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: C.error },
  ...
  input: { height: 54, borderRadius: 14, backgroundColor: C.fill, paddingHorizontal: 16, fontSize: 18, fontWeight: '700', fontFamily: 'Inter_700Bold', color: C.text },
