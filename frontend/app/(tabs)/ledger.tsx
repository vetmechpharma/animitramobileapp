...
const s = StyleSheet.create({
  ...
  totalFarmerNum: { fontSize: 28, fontWeight: '800', color: '#fff' },
  ...
  // Farmer card
  farmerCard: { backgroundColor: C.surface, borderRadius: 18, overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2 },
  ...
  farmerAvatarText: { fontSize: 18, fontWeight: '800', color: C.error },
  farmerName: { fontSize: 16, fontWeight: '800', color: C.text },
  farmerVillage: { fontSize: 12, color: C.sub, marginTop: 1 },
  farmerCases: { fontSize: 12, color: C.sub, marginTop: 2 },
  farmerTotal: { fontSize: 22, fontWeight: '800', color: C.error },
  ...
  caseListTitle: { fontSize: 13, fontWeight: '700', color: C.sub },
  ...
  caseNumText: { fontSize: 11, fontWeight: '700', color: C.primary },
  caseReason: { fontSize: 13, fontWeight: '600', color: C.text },
  caseDate: { fontSize: 11, color: C.sub, marginTop: 2 },
  casePartialNote: { fontSize: 11, color: C.warning, marginTop: 2 },
  caseOutstanding: { fontSize: 15, fontWeight: '700', color: C.error },
  casePartialBadge: { fontSize: 9, fontWeight: '700', color: C.warning, backgroundColor: '#FFF3E0', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6, marginTop: 2 },
  ...
  totalRowLabel: { fontSize: 13, fontWeight: '700', color: C.text },
  totalRowAmount: { fontSize: 16, fontWeight: '800', color: C.error },
  // Farmer actions
  ...
  sheet: { backgroundColor: C.surface, borderTopLeftRadius: 32, borderTopRightRadius: 32, paddingHorizontal: 20, paddingBottom: Platform.OS === 'ios' ? 36 : 20 },
  ...
  summaryTotal: { fontSize: 20, fontWeight: '800', color: C.error },
  summaryBalance: { fontSize: 13, fontWeight: '700', color: C.warning },
  label: { fontSize: 11, fontWeight: '600', color: C.sub, letterSpacing: 0.8, marginBottom: 8, marginTop: 12 },
  input: { height: 54, borderRadius: 14, backgroundColor: C.fill, paddingHorizontal: 16, fontSize: 18, fontWeight: '700', color: C.text },
  ...
  saveBtn: { height: 54, backgroundColor: C.primary, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginTop: 14 },
