...
const styles = StyleSheet.create({
  ...
  tabLabel: { fontSize: 11, fontWeight: '600', fontFamily: 'Inter_600SemiBold', color: C.sub, marginTop: 2 },
  tabLabelActive: { color: C.primary },
  listContent: { padding: 16, gap: 12, paddingBottom: 40 },
  emptyBox: { alignItems: 'center', paddingTop: 60 },
  emptyEmoji: { fontSize: 48, marginBottom: 12 },
  emptyText: { fontSize: 14, color: C.sub },
  card: { backgroundColor: C.surface, borderRadius: 16, padding: 14, boxShadow: '0px 2px 10px rgba(46,125,50,0.07)' },
  fwdBadge: { backgroundColor: '#E3F2FD', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4, alignSelf: 'flex-start', marginBottom: 8 },
  fwdText: { fontSize: 11, color: C.blue, fontWeight: '600', fontFamily: 'Inter_600SemiBold' },
  cardRow: { flexDirection: 'row', marginBottom: 10 },
  cardOwner: { fontSize: 13, fontWeight: '700', fontFamily: 'Inter_700Bold', color: C.text },
  cardVillage: { fontSize: 12, color: C.sub, marginTop: 1 },
  cardMeta: { fontSize: 12, color: C.sub, marginTop: 1 },
  cardDate: { fontSize: 12, color: C.primary, fontWeight: '600', fontFamily: 'Inter_600SemiBold', marginTop: 2 },
  ...
  fwdBtnText: { fontSize: 13, fontWeight: '700', fontFamily: 'Inter_700Bold', color: '#fff' },
  // Modal
  overlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.45)', justifyContent: 'flex-end' },
  sheet: { backgroundColor: C.surface, borderTopLeftRadius: 28, borderTopRightRadius: 28, paddingHorizontal: 14, paddingBottom: Platform.OS === 'ios' ? 32 : 16 },
  ...
  label: { fontSize: 11, fontWeight: '600', fontFamily: 'Inter_600SemiBold', color: C.sub, letterSpacing: 0.8, marginBottom: 6, marginTop: 14 },
  ...
  toggleText: { fontSize: 13, fontWeight: '600', fontFamily: 'Inter_600SemiBold', color: C.text },
  ...
  outstandingText: { fontSize: 13, color: C.warning, fontWeight: '600', fontFamily: 'Inter_600SemiBold' },
  datePill: { backgroundColor: C.secondary, borderRadius: 10, padding: 12, marginTop: 8 },
  datePillText: { fontSize: 14, fontWeight: '600', fontFamily: 'Inter_600SemiBold', color: C.primary },
  ...
  infoBox: { backgroundColor: '#E3F2FD', borderRadius: 10, padding: 10, marginTop: 8 },
  infoText: { fontSize: 13, color: C.blue },
  saveBtn: { height: 46, backgroundColor: C.primary, borderRadius: 14, justifyContent: 'center', alignItems: 'center', marginTop: 16 },
