...
const s = StyleSheet.create({
  ...
  appName: { fontSize: 28, fontWeight: '800', color: C.primary },
  ...
  sectionTitle: { fontSize: 17, fontWeight: '800', color: C.text, marginBottom: 12, borderLeftWidth: 3, borderLeftColor: C.primary, paddingLeft: 10 },
  ...
  infoTitle: { fontSize: 18, fontWeight: '800', color: C.primary, marginBottom: 12 },
  ...
  contactValue: { fontSize: 15, fontWeight: '600', color: C.text },
