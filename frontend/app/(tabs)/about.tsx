...
const s = StyleSheet.create({
  ...
  section: { paddingHorizontal: 14, paddingTop: 24, paddingBottom: 8 },
  sectionTitle: { fontSize: 14, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: C.text, marginBottom: 12, borderLeftWidth: 3, borderLeftColor: C.primary, paddingLeft: 10 },
  ...
  featureEmoji: { fontSize: 13, marginTop: 2 },
  ...
  infoTitle: { fontSize: 13, fontWeight: '800', fontFamily: 'Inter_800ExtraBold', color: C.primary, marginBottom: 12 },
