...
const s = StyleSheet.create({
  ...
  summaryCard: {
    backgroundColor: C.primary, borderRadius: 20, padding: 20, alignItems: 'center', marginBottom: 16,
  },
  summaryNum: { fontSize: 40, fontWeight: '800', color: '#fff' },
  ...
  barLabel: { fontSize: 15, fontWeight: '600', color: C.text, flex: 1 },
  barMeta: { flexDirection: 'row', alignItems: 'center' },
  barCount: { fontSize: 16, fontWeight: '800' },
  ...
  forwardOwner: { fontSize: 15, fontWeight: '700', color: C.text },
  forwardMeta: { fontSize: 12, color: C.sub, marginTop: 2 },
  forwardVillage: { fontSize: 12, color: C.sub, marginTop: 1 },
  forwardedTo: { fontSize: 12, color: '#1565C0', fontWeight: '600', marginTop: 4 },
  forwardDate: { fontSize: 13, color: C.primary, fontWeight: '600' },
});
