...
const s = StyleSheet.create({
  ...
  barLabel: { fontSize: 15, fontWeight: '600', fontFamily: 'Inter_600SemiBold', color: C.text, flex: 1 },
  barMeta: { flexDirection: 'row', alignItems: 'center' },
  barCount: { fontSize: 16, fontWeight: '800', fontFamily: 'Inter_800ExtraBold' },
  ...
  forwardOwner: { fontSize: 15, fontWeight: '700', fontFamily: 'Inter_700Bold', color: C.text },
